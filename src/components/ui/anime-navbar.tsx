    ...
    return (
        <div className="fixed top-5 left-0 right-0 z-[9999]">
            <div className="flex justify-center pt-1">
                <motion.div
                    className="flex items-center gap-2 bg-black/60 border border-white/10 backdrop-blur-xl py-2 px-2 rounded-full shadow-2xl relative"
                        ...
                        return (
                            ...
                            >
                                {isActive && (
                                    ...
                                    >
                                        <div className="absolute inset-0 bg-zemoOrange/30 rounded-full blur-md" />
                                        <div className="absolute inset-[-4px] bg-zemoOrange/20 rounded-full blur-xl" />

                                        <div
                                            className="absolute inset-0 bg-gradient-to-r from-zemoOrange/0 via-zemoOrange/30 to-zemoOrange/0"
                                            style={{
